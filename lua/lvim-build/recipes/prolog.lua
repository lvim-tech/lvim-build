-- lvim-build.recipes.prolog: build / validate the current PROLOG file. swipl syntax check / run.
...
--
---@module "lvim-build.recipes.prolog"

---@type table<string, boolean>
local FT = { ["prolog"] = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("swipl", "swipl -q --check " .. base, "Lint", { "swipl", "-q", "-g", "halt", "-t", "halt", ctx.file })
        add("swipl", "swipl " .. base, "Run", { "swipl", ctx.file })
        return out
    end,
}
