-- lvim-build.recipes.yaml: validate the current YAML file. yamllint / prettier check.
...
--
---@module "lvim-build.recipes.yaml"
...
return {
    ...
    detect = function(ctx)
        ...
        add("yamllint", "yamllint " .. base, "Lint", { "yamllint", ctx.file })
