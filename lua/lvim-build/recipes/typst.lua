-- lvim-build.recipes.typst: build / validate the current TYPST file. typst compile.
...
--
---@module "lvim-build.recipes.typst"
...
return {
    ...
    detect = function(ctx)
        ...
        add("typst", "typst compile " .. base, "Build", { "typst", "compile", ctx.file })
        return out
    end,
}
