-- lvim-build.recipes.xml: validate the current XML file. xmllint well-formedness.
...
--
---@module "lvim-build.recipes.xml"

---@type table<string, boolean>
local FT = { xml = true, xsd = true, xsl = true, xslt = true, svg = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("xmllint", "xmllint --noout " .. base, "Lint", { "xmllint", "--noout", ctx.file })
        return out
    end,
}
