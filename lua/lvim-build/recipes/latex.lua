-- lvim-build.recipes.latex: build / validate the current LATEX file. latexmk -pdf.
...
--
---@module "lvim-build.recipes.latex"

---@type table<string, boolean>
local FT = { ["tex"] = true, ["plaintex"] = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("latexmk", "latexmk -pdf " .. base, "Build", { "latexmk", "-pdf", ctx.file })
        return out
    end,
}
