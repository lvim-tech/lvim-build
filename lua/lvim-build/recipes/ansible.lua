-- lvim-build.recipes.ansible: validate the current ANSIBLE file / chart. ansible-lint.
...
--
---@module "lvim-build.recipes.ansible"

---@type table<string, boolean>
local FT = { ["yaml.ansible"] = true, ["ansible"] = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("ansible-lint", "ansible-lint " .. base, "Lint", { "ansible-lint", ctx.file })
        return out
    end,
}
