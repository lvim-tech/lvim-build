-- lvim-build.recipes.solidity: build / validate the current SOLIDITY file. solhint / forge fmt --check.
...
--
---@module "lvim-build.recipes.solidity"

---@type table<string, boolean>
local FT = { ["solidity"] = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("solhint", "solhint " .. base, "Lint", { "solhint", ctx.file })
        add("forge", "forge fmt --check " .. base, "Lint", { "forge", "fmt", "--check", ctx.file })
        return out
    end,
}
