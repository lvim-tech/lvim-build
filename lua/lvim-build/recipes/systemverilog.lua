-- lvim-build.recipes.systemverilog: build / validate the current SYSTEMVERILOG file. verible lint.
...
--
---@module "lvim-build.recipes.systemverilog"

---@type table<string, boolean>
local FT = { ["verilog"] = true, ["systemverilog"] = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("verible-verilog-lint", "verible-verilog-lint " .. base, "Lint", { "verible-verilog-lint", ctx.file })
        return out
    end,
}
