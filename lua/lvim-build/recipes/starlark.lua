-- lvim-build.recipes.starlark: build / validate the current STARLARK file. buildifier check.
...
--
---@module "lvim-build.recipes.starlark"

---@type table<string, boolean>
local FT = { ["bzl"] = true, ["starlark"] = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("buildifier", "buildifier --mode=check " .. base, "Lint", { "buildifier", "--mode=check", ctx.file })
        return out
    end,
}
