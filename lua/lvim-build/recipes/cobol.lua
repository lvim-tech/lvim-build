-- lvim-build.recipes.cobol: build / validate the current COBOL file. cobc syntax check.
...
--
---@module "lvim-build.recipes.cobol"
...
return {
    ...
    detect = function(ctx)
        ...
        add("cobc", "cobc -fsyntax-only " .. base, "Lint", { "cobc", "-fsyntax-only", ctx.file })
        return out
    end,
}
