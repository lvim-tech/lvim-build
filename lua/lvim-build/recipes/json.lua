-- lvim-build.recipes.json: validate the current JSON file. jsonlint / jq / prettier check.
...
--
---@module "lvim-build.recipes.json"

---@type table<string, boolean>
local FT = { json = true, jsonc = true, json5 = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("jsonlint", "jsonlint " .. base, "Lint", { "jsonlint", "-q", ctx.file })
        add("jq", "jq empty " .. base, "Lint", { "jq", "empty", ctx.file })
