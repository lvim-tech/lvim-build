-- lvim-build.recipes.jsonnet: build / validate the current JSONNET file. jsonnetfmt check.
...
--
---@module "lvim-build.recipes.jsonnet"

---@type table<string, boolean>
local FT = { ["jsonnet"] = true, ["libsonnet"] = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("jsonnetfmt", "jsonnetfmt -test " .. base, "Lint", { "jsonnetfmt", "-test", ctx.file })
        return out
    end,
}
