-- lvim-build.recipes.powershell: build / validate the current POWERSHELL file. pwsh run.
...
--
---@module "lvim-build.recipes.powershell"
...
return {
    ...
    detect = function(ctx)
        ...
        add("pwsh", "pwsh " .. base, "Run", { "pwsh", "-NoLogo", "-NoProfile", "-File", ctx.file })
        return out
    end,
}
