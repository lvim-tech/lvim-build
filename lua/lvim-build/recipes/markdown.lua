-- lvim-build.recipes.markdown: validate the current MARKDOWN file. markdownlint / prettier check.
...
--
---@module "lvim-build.recipes.markdown"
...
return {
    ...
    detect = function(ctx)
        ...
        add("markdownlint", "markdownlint " .. base, "Lint", { "markdownlint", ctx.file })
