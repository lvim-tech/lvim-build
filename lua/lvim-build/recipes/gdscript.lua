-- lvim-build.recipes.gdscript: build / validate the current GDSCRIPT file. gdformat check / gdlint.
...
--
---@module "lvim-build.recipes.gdscript"

---@type table<string, boolean>
local FT = { ["gdscript"] = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("gdformat", "gdformat --check " .. base, "Lint", { "gdformat", "--check", ctx.file })
        add("gdlint", "gdlint " .. base, "Lint", { "gdlint", ctx.file })
        return out
    end,
}
