-- lvim-build.recipes.css: validate the current CSS file. stylelint / prettier check.
...
--
---@module "lvim-build.recipes.css"

---@type table<string, boolean>
local FT = { css = true, scss = true, less = true, sass = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("stylelint", "stylelint " .. base, "Lint", { "stylelint", ctx.file })
