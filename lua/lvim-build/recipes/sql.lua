-- lvim-build.recipes.sql: validate the current SQL file / chart. sqlfluff lint.
...
--
---@module "lvim-build.recipes.sql"

---@type table<string, boolean>
local FT = { ["sql"] = true, ["mysql"] = true, ["plsql"] = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("sqlfluff", "sqlfluff lint " .. base, "Lint", { "sqlfluff", "lint", "--dialect", "ansi", ctx.file })
        return out
    end,
}
