-- lvim-build.recipes.dockerfile: validate the current DOCKERFILE file / chart. hadolint.
...
--
---@module "lvim-build.recipes.dockerfile"

---@type table<string, boolean>
local FT = { ["dockerfile"] = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("hadolint", "hadolint " .. base, "Lint", { "hadolint", ctx.file })
        return out
    end,
}
