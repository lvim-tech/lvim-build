-- lvim-build.recipes.matlab: build / validate the current MATLAB file. octave run.
...
--
---@module "lvim-build.recipes.matlab"

---@type table<string, boolean>
local FT = { ["matlab"] = true, ["octave"] = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("octave", "octave " .. base, "Run", { "octave", "--no-gui", ctx.file })
        return out
    end,
}
