-- lvim-build.recipes.svelte: validate the current SVELTE file. prettier --check / eslint_d.
...
--
---@module "lvim-build.recipes.svelte"

---@type table<string, boolean>
local FT = { ["svelte"] = true }
...
return {
    ...
    detect = function(ctx)
        ...
        add("eslint_d", "eslint_d " .. base, "Lint", { "eslint_d", ctx.file })
        return out
    end,
}
