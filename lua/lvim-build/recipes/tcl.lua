-- lvim-build.recipes.tcl: build / validate the current TCL file. tclint / tclsh run.
...
return {
    ...
    detect = function(ctx)
        ...
        add("tclint", "tclint " .. base, "Lint", { "tclint", ctx.file })
        add("tclsh", "tclsh " .. base, "Run", { "tclsh", ctx.file })
        return out
    end,
}
